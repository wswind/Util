...
namespace Util.Biz.Payments.Factories {
    ...
    public class PayFactory : IPayFactory {
        ...
        public PayFactory( IAlipayConfigProvider alipayConfigProvider, IWechatpayConfigProvider wechatpayConfigProvider , IHttpContextAccessor httpContextAccessor) {
        ...
        /// <param name="wechatpayConfigProvider">微信支付配置提供器</param>
        /// <param name="httpContextAccessor"></param>
        public PayFactory(IWechatpayConfigProvider wechatpayConfigProvider, IHttpContextAccessor httpContextAccessor)
        {
            _alipayConfigProvider = null;
            _wechatpayConfigProvider = wechatpayConfigProvider;
            _httpContextAccessor = httpContextAccessor;
        }
        ...
        public IWechatpayNotifyService CreateWechatpayNotifyService() {
            return new WechatpayNotifyService( _wechatpayConfigProvider , _httpContextAccessor);
        }
